...
public class attendances extends AppCompatActivity {
    ...
    public class FirebaseHelper {
       ...
       */
        ...
        public ArrayList<cutoffclass> retrieve() {
            db.child("attendance").orderByChild("name").addValueEventListener(new ValueEventListener() {
                @Override
           ...
           cutoffTextView.setText(s.getName());
            ...
            convertView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent a= new Intent(attendances.this,tryfirebase.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!checknetwork(attendances.this)) {
