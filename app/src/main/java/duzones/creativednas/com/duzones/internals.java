...
public class internals extends AppCompatActivity {
    ...
    public class FirebaseHelper {
       ...
       */
        ...
        public ArrayList<cutoffclass> retrieve() {
            db.child("internals").orderByChild("name").addValueEventListener(new ValueEventListener() {
                @Override
           ...
           cutoffTextView.setText(s.getName());
            ...
            convertView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent a= new Intent(internals.this,tryfirebase.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!checknetwork(internals.this))
        {
